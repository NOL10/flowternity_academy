...
export const SPORTS = [
  ...
  { id: 'karate', name: 'Karate', status: 'active', description: 'Traditional karate training — kata, kumite, discipline and technique.', tagline: 'Kihon · Kata · Kumite', image: 'https://images.unsplash.com/photo-1555597673-b21d5c935865?auto=format&fit=crop&q=80&w=1200' },
  { id: 'skating', name: 'Skating', status: 'active', description: 'Professional skating facilities. Ice & roller.', tagline: 'Ice · Roller', image: 'https://images.unsplash.com/photo-1696685139596-ed3f10bbb6f0?auto=format&fit=crop&q=80&w=1200' },
